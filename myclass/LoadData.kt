...
class LoadData(context: Context) {
    init {
        ...
        homeArrayList.add(
            ItemClass(
                "A4 Notebook", 
                "Classmate Pulse A4 Notebook Unruled 300 Pages  (Multicolor)", 
                179,
                R.drawable.notbook, 
                itemCartColor, 
                0
        ...
        homeArrayList.add(
            ItemClass(
                "Home Delight 138 LEDs", 
                "Home Delight 138 LEDs 2.49 m Yellow Rice Lights  (Pack of 1)", 
                425,
        ...
        homeArrayList.add(
            ItemClass(
                "Hair Oil", 
                "Parachute Advansed Jasmine Gold Hair Oil  (1500 ml)", 
                544,
                R.drawable.oil, 
                itemCartColor, 
                0
        ...
        homeArrayList.add(
            ItemClass(
                "Girls Lehenga", 
                "Girls Lehenga Choli Party Wear Embroidered Lehenga, Choli and Dupatta Set  (Pink, Pack of 1)", 
                332,
                R.drawable.langa, 
                itemCartColor, 
                0
